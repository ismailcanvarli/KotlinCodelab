...
/**
 * Kalıcı bir dosyaya resmi kaydeder
 */
class SaveImageToFileWorker(ctx: Context, params: WorkerParameters) : CoroutineWorker(ctx, params) {
    ...
    override suspend fun doWork(): Result {
        // Resmi kaydetmeye başladığında bir bildirim oluşturur ve
        // her WorkRequest'in başlangıcını görmeyi kolaylaştırmak için işi yavaşlatır
