...
fun TipTimeLayout() {
    ...
    //sağa sola rotate için eğer sayfaya sığmazsa diye scroll ekledik
    Column(
        modifier = Modifier
            .statusBarsPadding()
...
/**
 * Burada bu kod bloğunun testini yazacağımız için bunu privet olmaktan çıkardık.
 * Ve visibleForTesting anotasyonunu ekledik ki test edilebilir olsun
 */
@VisibleForTesting
